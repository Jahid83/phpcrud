...
<html>
	<head>
		...
		.tbleone{width: 100%;border: 1px solid #fff;margin: 20px 0}
		.tbleone td{padding: 5px 10px;text-align: center;}
		table.tbleone tr:nth-child(2n+1){background:#fff;height: 30px;}
		table.tbleone tr:nth-child(2n){background:#f1f1f1;height: 30px;}
